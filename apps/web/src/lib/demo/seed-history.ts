 ...
 */
// Closed dates are spread on purpose so the CRM's Cerradas column shows the
// three greens on its first three cards — one close this month (won green),
// one last quarter (lime), the rest older (mint) — and Ventas still has a
// bar in most of the last six months.
const SEEDS: SeedDef[] = [
  ...
  { id: "s06", company: "Solaris Manufactura", domain: "solarismfg.mx", industry: "Manufactura", country: "México", signalType: "hiring", leadName: "Patricia León", leadTitle: "Gerente Comercial", seniority: "manager", amount: 19500, score: 65, daysAgoCreated: 110, outcome: "won", cycleDays: 45, qualifiedCount: 5 },
  ...
  { id: "s09", company: "Horizonte Legal", domain: "horizontelegal.cl", industry: "LegalTech", country: "Chile", signalType: "news_mention", leadName: "Ignacio Fuentes", leadTitle: "Socio Director", seniority: "c_level", amount: 29000, score: 79, daysAgoCreated: 100, outcome: "won", cycleDays: 39, qualifiedCount: 5 },
  ...
  { id: "s17", company: "Silo Data Works", domain: "silodata.io", industry: "Datos / Analytics", country: "Estados Unidos", signalType: "engagement", leadName: "Taylor Brooks", leadTitle: "Head of Revenue", seniority: "director", amount: 39000, score: 81, daysAgoCreated: 120, outcome: "won", cycleDays: 48, qualifiedCount: 6 },
