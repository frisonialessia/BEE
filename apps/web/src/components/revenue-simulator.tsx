  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between text-xs">
        ...
        <span className="font-semibold">{scenario.projected_won_deals} deals</span>
        {scenario.uplift_vs_baseline > 0 && (
          <span className="text-[10px] text-muted-foreground">
            +{scenario.uplift_vs_baseline} vs baseline
          </span>
        )}
      </div>
  ...
  return (
    <div className="bee-bento bee-bento--warm bee-bento-pad space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="space-y-1">
          <label className="bee-kpi-tile__label">Signal</label>
          <select
            value={signalType}
        ...
        <div className="space-y-1">
          <label className="bee-kpi-tile__label">Industry</label>
          <input
            type="text"
            value={industry}
        ...
        <div className="space-y-1">
          <label className="bee-kpi-tile__label">Multiplier ({factor}×)</label>
          <input
            type="range"
            min={1.5}
            max={5}
        ...
        <div className="space-y-4 border-t border-border pt-4">
          <div className="bee-bento bee-bento--primary bee-bento-pad space-y-2">
            <div className="flex items-center justify-between">
              <span className="bee-kpi-tile__label">Realistic projection</span>
            ...
            {result.top_playbook && (
              <div className="flex items-center gap-2 text-[10px] text-muted-foreground">
                ...
                Top tactic: <span className="text-foreground">{result.top_playbook}</span>
                {result.top_channel && (
                  <>
                    {" "}
                    via <span className="text-foreground">{result.top_channel}</span>
                  </>
                )}
              </div>
            )}
          ...
          <div className="bee-stat-grid">
            <div className="bee-stat">
              ...
              <div className="bee-stat__lbl">Win rate</div>
            </div>
            <div className="bee-stat">
            ...
            <div className="bee-stat">
              ...
              <div className="bee-stat__lbl">Data pts</div>
            </div>
          </div>
