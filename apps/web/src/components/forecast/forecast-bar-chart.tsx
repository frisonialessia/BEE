...
export function ForecastBarChart({ buckets }: { buckets: ForecastMonthBucket[] }) {
  ...
  return (
    ...
    // off the left edge.
    <div className="bee-fill flex min-h-[160px] flex-col gap-2 sm:flex-row sm:items-stretch sm:gap-4">
      <div className="flex w-full min-w-0 flex-1 items-end gap-2 pb-1 sm:gap-4" style={{ minHeight: 140 }}>
      {buckets.map((b, i) => {
