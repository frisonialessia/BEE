...
from app.schemas.signal import OpportunityOut, OpportunityUpdateIn
...
def update_opportunity(
    ...
    stays owned by ``PATCH /{id}/outcome`` (it carries feedback-loop and
    workflow side effects this endpoint must not trigger). Only the three
