...
def _is_dark_funnel_event(event_type: str, provider: str) -> bool:
    ...
    dark_providers = {"g2", "capterra", "google_search", "linkedin"}
...
def _map_dark_funnel_type(event_type: str) -> str:
    mapping = {
        "g2_review": "review_activity",
        "g2_comparison": "comparison_research",
        "linkedin_research": "social_research",
        "page_view": "website_visit",
        "pricing_page_view": "pricing_research",
        "content_download": "content_download",
    }
    return mapping.get(event_type, "website_visit")
